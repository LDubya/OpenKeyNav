(function (global, factory) {
	...
	var toolbarTemplates = {
	  "default": function _default() {
	    ...
	    var menuButton = (0, _keyButton.keyButton)(openKeyNav$1.config.keys.menu, "Shortcuts");
	    // if(numButtons > 1){
	...
	(function (exports) {
	  ...
	  var OpenKeyNav = /*#__PURE__*/function () {
	    ...
	    return _createClass(OpenKeyNav, [{
	      ...
	      value: function injectStylesheet() {
	        var style = document.createElement('style');
	        style.type = 'text/css';
	        style.innerHTML = '' + '.openKeyNav-label {' + 'font: inherit;' + 'vertical-align: baseline;' + 'box-sizing: border-box;' + 'white-space: nowrap;' + "border: 1px solid ".concat(this.config.spot.fontColor, ";") +
	        ...
	        "background-color: ".concat(this.config.spot.backgroundColor, ";") +
	        ...
	        // 'padding : 0;' +
	        // 'margin : 0;' +
	        'display : grid;' + 'align-content : center;' + "color : ".concat(this.config.spot.fontColor, ";") + "background : ".concat(this.config.spot.backgroundColor, ";") +
	  ...
	  exports["default"] = OpenKeyNav;
	})(OpenKeyNav$1);
	var OpenKeyNav = /*@__PURE__*/getDefaultExportFromCjs(OpenKeyNav$1);
